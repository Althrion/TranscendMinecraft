package com.althrion.mod.classes.world.dimension;
...
import com.althrion.mod.init.TutorialDimensions;
import com.althrion.mod.init.TutorialTeleporter;
...
public class TeleporterOne extends BlockBreakable {
	...
	public static class Size {
		...
		public void placePortalBlocks() {
			for(int i = 0; i < this.width; ++i) {
				...
				for(int j = 0; j < this.height; ++j) this.world.setBlockState(pos.up(j), BlockInit.PORTAL_1.getDefaultState().withProperty(TeleporterOne.AXIS, this.axis), 2);
			}
		}
	}
