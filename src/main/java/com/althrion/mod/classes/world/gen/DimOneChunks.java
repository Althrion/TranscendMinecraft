package com.althrion.mod.classes.world.gen;
...
public class DimOneChunks implements IChunkGenerator{
	...
	public DimOneChunks(World world, boolean generateStructures, long seed) {
		this.world = world;
